...
class AdminController {
    ...
    public function create_user() {
        if ($_SESSION['role'] !== 'admin') { header("Location: index.php?controller=admin&action=dashboard"); exit; }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if ($userModel->getUserByEmail($email)) {
                ...
                if ($userModel->addUserAdmin($username, $email, $password, $role)) {
                    header("Location: index.php?controller=admin&action=users"); exit;
                } else {
    ...
    public function edit_user() {
        ...
        if (!$u) { header("Location: index.php?controller=admin&action=users"); exit; }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($error) && !empty($image_url)) {
                ...
                if ($bannerModel->addBanner($image_url, $target_url, $position)) {
                    header("Location: index.php?controller=admin&action=banners"); exit;
                } else {
    ...
    public function edit_banner() {
        ...
        if (!$b) { header("Location: index.php?controller=admin&action=banners"); exit; }
