...
<head>
    ...
    <link rel="stylesheet" href="public/css/admin/create_post.css">
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-body">
            ...
            <form action="index.php?controller=admin&action=create_post" method="POST" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <textarea name="summary" class="form-control" rows="3" required
                        placeholder="Đoạn tóm tắt ngắn hiển thị ở trang chủ..."></textarea>
                </div>
