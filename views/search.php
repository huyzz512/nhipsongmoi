...
<main class="container main-body">
    <div class="content-left">
        <h1 class="page-title"
            style="border-bottom: 2px solid #b71c1c; margin-bottom: 20px; padding-bottom: 10px; font-size: 1.5rem;">
            ...
            <?php if (!empty($posts)):
                foreach ($posts as $news): ?>
                    <article class="news-row">
                        ...
                        <div class="desc">
                            <span
                                style="background: #eee; padding: 3px 8px; font-size: 0.8rem; border-radius: 3px; color: #555; margin-bottom: 5px; display: inline-block;">
    ...
    <aside class="sidebar-right">
        <div class="widget ads">
            <img src="https://images.unsplash.com/photo-1626243280056-9a2c1e63d395?w=300&h=400&fit=crop" alt="VDPR Ads"
